...
clone git github.com/opencontainers/runc 4d973445939175eba9312e26f060a1b1c8f860c9 git@code.huawei.com:docker/runc.git # libcontainer
...
# containerd
clone git github.com/docker/containerd e774d7d9086557749a5f0230e1c1446822c62c98 git@code.huawei.com:docker/containerd.git
