...
This option is only available for the `devicemapper`. For the `devicemapper` graph drivers,
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><strong>on-reboot</strong></td>
      <td>
        Restart container if the exit code is 129.
      </td>
    </tr>
  </tbody>
</table>
